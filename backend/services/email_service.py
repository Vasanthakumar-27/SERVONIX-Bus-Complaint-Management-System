...
class EmailService:
    ...
    def __init__(self):
        ...
        # Re-enabled for production use with verified domain
        self.resend_api_key = os.environ.get('RESEND_API_KEY', '')
        # From address for Resend: override via RESEND_FROM env var.
        # IMPORTANT: Use a verified domain, NOT the sandbox onboarding@resend.dev
        self.resend_from = os.environ.get('RESEND_FROM', f'SERVONIX <noreply@servonix.com>')
