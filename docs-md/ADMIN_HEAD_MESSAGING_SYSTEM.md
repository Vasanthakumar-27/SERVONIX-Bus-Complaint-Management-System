...
**Status Badges:**
- ≡ƒƒí **Pending**: Awaiting Head response
- ≡ƒƒó **Replied**: Head has responded
- ΓÜ¬ **Resolved**: Conversation closed
...
2. Clicks mail icon ΓåÆ sees preview in dropdown
...
- [ ] Admin sends ΓåÆ Head receives
- [ ] Head replies ΓåÆ Admin sees reply
- [ ] Head resolves ΓåÆ Status updates
