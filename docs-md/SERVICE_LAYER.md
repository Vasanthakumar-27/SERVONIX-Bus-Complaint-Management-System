...
**Features**:
- Γ£à Development mode (logs emails to console when SMTP not configured)
- Γ£à Production mode (sends via SMTP)
- Γ£à Beautiful HTML email templates
- Γ£à OTP email for password reset
- Γ£à Notification emails
- Γ£à Complaint status update emails
- Γ£à Welcome emails for new users
...
**Features**:
- Γ£à File extension validation by category
- Γ£à File size validation (category-based limits)
- Γ£à Automatic filename sanitization
- Γ£à Duplicate filename handling
- Γ£à File metadata extraction
- Γ£à File deletion
- Γ£à Support for images, videos, and documents
...
**Features**:
- Γ£à Client connection/disconnection handling
- Γ£à User registration for targeted notifications
- Γ£à Real-time notification updates
- Γ£à Complaint update broadcasting
- Γ£à System-wide message broadcasting
- Γ£à Connected users tracking
